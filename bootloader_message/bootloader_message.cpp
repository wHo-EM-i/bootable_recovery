...
static const size_t SYSTEM_SPACE_OFFSET_IN_MISC = 32 * 1024 + BOOTLOADER_MESSAGE_OFFSET_IN_MISC;
static const size_t SYSTEM_SPACE_SIZE_IN_MISC = 32 * 1024 + BOOTLOADER_MESSAGE_OFFSET_IN_MISC;
